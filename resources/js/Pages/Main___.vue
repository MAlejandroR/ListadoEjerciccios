...
<template>
    ...
    <div class="flex flex-col min-h-screen bg-slate-50">
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <SidebarExercises class="bg-white border-r border-gray-100 flex flex-col"
            ...
            <main class="flex flex-1 p-6 bg-slate-50 overflow-auto">
                ...
                <div class="max-w-5xl mx-auto w-full space-y-6">
                    ...
                    <section class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 min-h-[250px]">
